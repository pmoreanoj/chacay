...
$sql="insert into noticias values('','$vtit','$ni1','$vtex',Now())";
mysql_query($sql);
...
<form action="inoticia.php" method="post" enctype="multipart/form-data" name="fdoc" id="fdoc">
        <table border="0" align="center" cellpadding="1" cellspacing="2" bgcolor="#F4F4F4">
          <tr>
            <td>&nbsp;</td>
            <td class="Estilo10">Llene el siguiente formulario para ingresar noticia </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><?php 
          ...
          <tr>
            ...
            <td width="540"><input name="tit" type="text" id="tit" size="50" maxlength="100"></td>
          </tr>
          <tr>
            <td><div align="right"><strong>Imagen:</strong></div></td>
            <td><input name="fotn" type="file" id="fotn"><br /><span class="textop">Puede ingresar archivos (Tama&ntilde;o Max.1MB, formatos: jpj, gif)</span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><input name="env" type="button" class="boton" id="env" onClick="enviot(fdoc)" value="Guardar"></td>
          </tr>
        </table>
      </form>
</body>
