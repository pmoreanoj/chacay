...
$rp=mysql_fetch_object(mysql_query("select * from contenidos where idc=1"));
?>
...
<div id="contenedor">
  ...
  <div id="contenido">
    ...
    <div class="textos">
    <h1>ABOUT US</h1><br />
      <div class="imagenes_articulos"><script type="text/javascript">
...
new fadeshow(fadeimages, 400, 250, 0, 5000, 1, "R")
</script> </div>
      <?php echo $rp->des; ?>
