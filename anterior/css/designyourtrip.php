...
<head>
	...
	<title>Chacay - Building bridges, Touching lives</title>
		...
		<header>
			...
			<div id="flags">
				...
				<ul>
					...
					<li><a href="#"><img src="images/icons/espanol.jpg" alt="Español" /></a></li>
					<li><a href="#"><img src="images/icons/english.jpg" alt="English" /></a></li>
				</ul>	
				
				<ul style="margin-top:10px;">
    	
    					<li><a href="#" target="_blank"><img src="images/facebookicon.png" /></a></li>
    					<li><a href="#" target="_blank"><img src="images/twittericon.png" /></a></li>
    					<li><a href="http://www.flickr.com/photos/70245493@N06/" target="_blank"><img src="images/flickricon.png" /></a></li>
    					<li><a href="#" target="_blank"><img src="images/youtubeicon.png" /></a></li>
			...
			<div id="menu-superior">
				...
				<ul>
					...
					<li><a href="findyourprogram.html">Find your program</a></li>
            ...
            <div id="logochacay"><img src="images/logochacay.png" alt="Chacay - Building Bridges, Touching lives" /></div>
			...
			<div style="font-family: Verdana, Geneva, sans-serif;">	
				...
				<form action="" method="post">
                    ...
                    <label for="btsend">&nbsp;</label>
                            ...
                            <button name="btsend" type="submit" id="btsend" onclick="MM_validateForm('name','','R','email','','RisEmail','mensaje','','R');return document.MM_returnValue">Send</button>
              </form> 
			</div>				
